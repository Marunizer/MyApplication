package sadappp.myapplication.model3D.model;
...
import sadappp.myapplication.model3D.services.WavefrontLoader.Materials;
import sadappp.myapplication.model3D.services.WavefrontLoader.Tuple3;
import sadappp.myapplication.model3D.services.wavefront.WavefrontLoader2;
import sadappp.myapplication.util.math.Math3DUtils;
...
public final class Object3DBuilder {
	...
	static {
		System.setProperty("java.protocol.handler.pkgs", "sadappp.myapplication.util.url|"+System.getProperty("java.protocol.handler.pkgs"));
